...
**現在は1〜4気筒モデルに対応しています。AudioWorklet 内で回転・燃焼位相・解析的な燃焼パルスを音声時間から計算し、停止中にプリセットと720°周期の燃焼位相を編集できます。画面では開始・停止、音量、ミュート、スライダー・数値・ホールドによるアクセル、簡易ダイノ負荷を操作でき、RPM、実効開度、レブリミッター状態も低頻度 telemetry として表示します。**
